...
def get_tag_regexes(session):
  ...
  tag_regexes = {
    ...
    "cast": [
      re.compile(r'\bCast[s]?\b')
    ],
    "attacks": [
      re.compile(r'\bAttacks\b')
    ],
    "attacked": [
      re.compile(r'\bAttacked\b')
    ],
    "provoke": [
      re.compile(r'\bProvok(es)?(ing)?\b')
    ],
    "defend": [
      re.compile(r'\bDefend(s)?(ing)?\b')
    ],
    "spell-gem": [
      re.compile(r'\bSpell Gem(s)?\b')
    ],
    "timeline": [
      re.compile(r'\bTimeline\b')
    ],
    "health": [
      re.compile(r'\bHealth\b')
    ],
    "current-health": [
      re.compile(r'\bCurrent Health\b')
    ],
    "maximum-health": [
      re.compile(r'\bMaximum Health\b')
    ],
    "attack": [
      re.compile(r'\bAttack\b')
    ],
    "intelligence": [
      re.compile(r'\bIntelligence\b')
    ],
    "defense": [
      re.compile(r'\bDefense\b')
    ],
    "speed": [
      re.compile(r'\bSpeed\b')
    ],
    "buff": [
      re.compile(r'\bbuff(s)?\b', re.IGNORECASE)
    ],
    "debuff": [
      re.compile(r'\bdebuff(s)?\b', re.IGNORECASE)
    ],
    "minion": [
      re.compile(r'\bminion(s)?\b', re.IGNORECASE)
    ],
    "race": [
      re.compile(r'\brace(s)?\b', re.IGNORECASE)
    ],
    "class": [
      re.compile(r'\bclass(s)?\b', re.IGNORECASE)
    ],
    "resurrect": [
      re.compile(r'\bresurrect(ion)?(ed)?\b', re.IGNORECASE)
    ],
    "heal": [
      re.compile(r'\bheal(ing)?(ed)?\b', re.IGNORECASE)
    ]
  }
